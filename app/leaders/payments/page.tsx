...
export const metadata: Metadata = {
  title: "Payments",
  description: "Secure Stripe Checkout payments for Leaders Portal membership subscriptions.",
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
      <div className="mb-10 max-w-3xl">
        ...
        <p className="font-body text-textMuted text-sm mt-3 leading-relaxed">
          Choose the number of annual subscriptions per section and pay securely in an embedded
          checkout flow without leaving the Leaders Portal.
        </p>
      </div>

      <div className="bg-navy-dark rounded-2xl p-6 sm:p-8 mb-8 text-white/85 border border-navy-dark/20">
      ...
      <p className="font-body text-xs text-textMuted mt-8">
