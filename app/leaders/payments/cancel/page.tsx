  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sm:p-10 text-center">
        ...
        <h1 className="font-display font-bold text-navy-dark text-3xl mb-3">Payment cancelled</h1>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-white border border-gray-200 text-navy-dark font-body font-semibold hover:bg-gray-50 transition-colors"
          >
            <RotateCcw size={15} />
            Refresh Status
          </Link>
